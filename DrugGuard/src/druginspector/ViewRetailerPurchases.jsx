                    ...
                    <tbody>
                      {filteredTransactions.map((tx) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3" style={{ color: '#60a5fa' }}>{tx.retailerName || '-'}</td>
            ...
            {shops.map((shop) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mt-4 pt-4" style={{ borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
                  ...
                  <div>
                    <p className="text-xs mb-1" style={{ color: '#94a3b8' }}>Total Qty Purchased</p>
                    <p className="font-bold text-lg" style={{ color: '#3b82f6' }}>{formatNumber(shop.totalQuantity)}</p>
                  </div>
                </div>
              ...
              <table className="w-full">
                <thead>
                  <tr style={{ background: 'rgba(255, 255, 255, 0.04)' }}>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-semibold" style={{ color: '#94a3b8' }}>Wholesaler</th>
                ...
                <tbody>
                  {selectedShopTransactions.map((tx) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4" style={{ color: '#e2e8f0' }}>{tx.wholesalerName || '-'}</td>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  <p className="text-sm mb-1" style={{ color: '#94a3b8' }}>Wholesaler</p>
                  <p className="font-semibold" style={{ color: '#e2e8f0' }}>{selectedBill.wholesalerName || '-'}</p>
                </div>
                <div>
                  <p className="text-sm mb-1" style={{ color: '#94a3b8' }}>Quantity</p>
                  <p className="font-bold text-xl" style={{ color: '#3b82f6' }}>{formatNumber(selectedBill.quantity)}</p>
                </div>
              </div>
            </div>
